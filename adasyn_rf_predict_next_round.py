...
def train_rf_model(X, y):
    """
    Treina o modelo RandomForest com balanceamento ADASYN.
    """
    print("Treinando o modelo RandomForest com ADASYN...")
    ...
    rf = RandomForestClassifier(n_estimators=470, max_depth=10, random_state=42, min_samples_split=2, min_samples_leaf=1)
