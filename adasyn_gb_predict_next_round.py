...
# ==============================================================================
# Função de Treinamento do Modelo ADASYN + Gradient Boosting
# ==============================================================================

def train_adasyn_gb_model(X, y):
    """
    Treina o modelo Gradient Boosting com balanceamento ADASYN.
    """
    print("Training the ADASYN + Gradient Boosting model...")
    ...
    # Definição do modelo Gradient Boosting
    gb = GradientBoostingClassifier(n_estimators=261, learning_rate=0.1784569549189997, max_depth=6, random_state=42, subsample=0.8185450708005443)
...
def main():
    ...
    # 3. Treinar o modelo ADASYN + Gradient Boosting
    model, scaler = train_adasyn_gb_model(X, y)
